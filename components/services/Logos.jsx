...
const Logos = () =>
  logos.map((logo) => (
    <div key={logo.name} className="flex flex-col items-center gap-8">
      ...
      <div
        className={`flex flex-col items-center justify-center gap-2 rounded-lg border border-black p-6 opacity-100 transition-opacity duration-300 ease-in-out hover:opacity-100 sm:opacity-30 ${logo.color}`}
      >
        <div
