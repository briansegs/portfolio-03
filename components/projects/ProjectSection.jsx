...
const ProjectCard = () => {
  ...
  const handleLeftClick = () => {
    setProject(projects[index - 1] ? projects[index - 1] : projects[projects.length - 1])
  ...
  return (
    <>
      ...
      <div className="mt-7 flex w-full items-center justify-between">
        <RoundArrowButton icon={<PiArrowFatLeftFill />} onClick={() => handleLeftClick()} />
            ...
            <div className="flex flex-col justify-between gap-6">
              ...
              <div className="min-h-[228px]">
                ...
                <p
                  ...
                  className="h-[168px] custom-scrollbar overflow-y-scroll pr-1 font-primary text-lg leading-6 tracking-[-0.4px]"
                >
                  {project.description}
                </p>
              </div>
        ...
        {/* Right Arrow Button */}
        <RoundArrowButton icon={<PiArrowFatRightFill />} onClick={() => handleRightClick()} />
      </div>
    </>
  )
}
